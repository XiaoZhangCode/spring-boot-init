...
import ${basePackage}.model.dto.${camelCaseEntityName}.${camelCaseEntityName}PageReqDTO;
import ${basePackage}.model.dto.${camelCaseEntityName}.${camelCaseEntityName}SaveReqDTO;
import ${basePackage}.model.entity.${pascalCaseEntityName};
import ${basePackage}.model.vo.${camelCaseEntityName}.${camelCaseEntityName}SimpleVo;
import ${basePackage}.model.vo.${camelCaseEntityName}.${camelCaseEntityName}Vo;
